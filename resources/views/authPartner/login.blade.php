    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card mt-9">
                ...
                <div class="card-header" style="padding-top: 0.5rem !important; padding-bottom: 0.5rem !important;">{{ __('PARTNER LOGIN') }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                      ...
                                      <input type="password" name="tel" placeholder="รหัสผ่าน" class="phone_format form-control" id="password">
                                    </div>
                                </div>
                            </div>
                        </div>
