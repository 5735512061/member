    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card mt-9">
                ...
                <div class="card-header" style="padding-top: 0.5rem !important; padding-bottom: 0.5rem !important;">{{ __('เข้าสู่ระบบสำหรับผู้ดูแลของร้านค้า') }}</div>

                <div class="card-body" style="padding-top: 0.5rem !important; padding-bottom: 0.5rem !important;">
                    <form method="POST" action="{{ route('admin-store.login.submit') }}" enctype="multipart/form-data">
                        @csrf
