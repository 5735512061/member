    ...
    <div class="campaign">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                ...
                <form action="{{url('update-campaign')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="row">
                                ...
                                <div class="card-header pb-0 pt-3 bg-transparent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <input type="date" name="start_date" placeholder="" class="form-control" value="{{$campaign->start_date}}">
                                        </div>
                                        <div class="col-md-12 mt-2">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <textarea name="detail" class="ckeditor form-control">{{$campaign->detail}}</textarea>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <p>สามารถใช้ได้ที่</p>
