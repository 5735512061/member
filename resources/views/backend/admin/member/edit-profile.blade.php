        ...
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6 mt-2">
                ...
                <input onkeyup="autoTab(this)" id="txtID" class="form-control" type="text" name="card_id" value="{{$member->card_id}}">
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 mt-2">
            ...
            <div class="row">
              <div class="col-md-12 mt-3">
                ...
                <button type="submit" class="btn btn-lg btn-success">แก้ไขข้อมูลสมาชิก</button>
              </div>
            </div>
        </div>
        </form>
