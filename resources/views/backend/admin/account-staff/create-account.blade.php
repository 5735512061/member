  ...
  <div class="row mt-4">
    ...
    <div class="col-lg-8 mb-lg-0 mb-4">
      <div class="card z-index-2 h-100">
        ...
        <form action="{{url('/create-account-staff')}}" enctype="multipart/form-data" method="post">@csrf
        <div class="card-body">
          <div class="account">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 mt-3">
                @php
                    $store_id = DB::table('account_stores')->where('store_name',$store_name)->where('branch',$branch)->value('id');
                @endphp
