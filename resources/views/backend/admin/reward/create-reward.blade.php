...
<div class="container-fluid py-4">
    <div class="reward">
        ...
        <h4 class="mt-4">สร้างของรางวัล </h4>
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                ...
                <form action="{{url('create-reward')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="row">
                                ...
                                <div class="card-header pb-0 pt-3 bg-transparent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            <button type="submit" class="btn btn-lg btn-success">เพิ่มของรางวัล</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
