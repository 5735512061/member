                                ...
                                <div class="card-header pb-0 pt-3 bg-transparent">
                                    <div class="row">
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <input class="form-control" type="text" placeholder="รับซาชิมิฟรี 1 เซต" name="name" value="{{$reward->name}}">
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <p>ประเภทของรางวัล</p>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            @php
                                                $point = DB::table('reward_points')->where('reward_id',$reward->id)->value('point');
                                            @endphp
                                            <p><span>*</span> พอยท์ที่ใช้แลก <span>(จำเป็นต้องกรอก)</span>
                                                @if ($errors->has('point'))
                                                    <span class="text-danger" style="font-size: 15px;">({{ $errors->first('point') }})</span>
                                                @endif
                                            </p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-success">อัพเดตของรางวัล</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
