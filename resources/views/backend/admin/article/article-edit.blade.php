    ...
    <div class="campaign">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-8">
                ...
                <form action="{{url('update-article')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="row">
                                ...
                                <div class="card-header pb-0 pt-3 bg-transparent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <textarea name="article" class="ckeditor form-control">{{$article->article}}</textarea>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <p>สถานะ</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-success">อัพเดตบทความ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
