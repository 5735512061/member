            ...
            <div class="col-lg-8 mt-4 mb-lg-0 mb-4">
                ...
                <div class="card z-index-2">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        ...
                        <form action="{{url('admin/search-member')}}">
                            <div class="row">
                                <div class="col-md-9">
                    ...
                    @foreach ($members as $member => $value)
                        ...
                        <div class="modal fade" id="addpoint{{$value->id}}" data-bs-backdrop="static" tabindex="-1">
                            <div class="modal-dialog">
                                <form action="{{url('admin/addpoint')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                                    ...
                                    <div class="modal-body">
                                        <div class="row">   
                                            <div class="col-md-12 mb-3">
                                                @php
                                                    $store_id = DB::table('account_stores')->where('id',Auth::guard('admin-store')->id())->value('id');
                                                    $store_name = DB::table('account_stores')->where('id',Auth::guard('admin-store')->id())->value('store_name');
                                                    $branch = DB::table('account_stores')->where('id',Auth::guard('admin-store')->id())->value('branch');
                                                @endphp
                                                <label class="form-label">สาขา</label>
                                                <select name="branch_id" class="form-control">
                                                    <option value="{{$store_id}}">{{$store_name}} สาขา{{$branch}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="bill_number" class="form-control" placeholder="หมายเลขรายการ"/>
                                            </div>
                                            <div class="col-md-12 mb-3">
