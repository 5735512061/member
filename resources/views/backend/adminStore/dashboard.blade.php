    ...
    <div class="member-list">
        <div class="row">
            <div class="col-lg-5 mt-4 mb-lg-0 mb-4">
                <form action="{{url('admin/search-member-list')}}">
                              ...
                              <tbody class="list">
                                  @foreach ($members as $member => $value)
                                      ...
                                      <tr style="text-align:center;">
                                          ...
                                          @endif
                                          <td>
                                              <a href="{{url('admin/member/profile')}}/{{$value->id}}" class="mt-2 btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></a>
                                          </td>
                                      </tr>
                                  @endforeach
                              </tbody>
