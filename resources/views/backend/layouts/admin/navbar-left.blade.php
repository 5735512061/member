...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ url('/member/list') }}">
                    ...
                    <span class="nav-link-text ms-1">ข้อมูลสมาชิกทั้งหมด</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ url('/reward') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-gift text-dark text-sm opacity-10 mb-2"></i>
                    </div>
            ...
            <li class="nav-item hr">
                <a class="nav-link " href="{{ url('/article') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-newspaper-o text-dark text-sm opacity-10 mb-2"></i>
                    </div>
            ...
            <li class="nav-item hr">
                <a class="nav-link " href="{{ url('/account-store') }}">
                    ...
                    <span class="nav-link-text ms-1">ข้อมูลบัญชีร้านค้า</span>
                </a>
            </li>
            <li class="nav-item hr">
        ...
        document.getElementById('logout-form').submit();">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-button-power text-dark text-sm opacity-10 mb-1"></i>
                    </div>
