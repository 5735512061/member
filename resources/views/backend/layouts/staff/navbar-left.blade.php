    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{url('staff/search-member-coupon')}}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-ticket text-success text-sm opacity-10 mb-2"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{url('staff/register-member')}}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-pencil-square-o text-danger text-sm opacity-10 mb-2"></i>
          </div>
      ...
      <li class="nav-item">
        ...
        <form id="logout-form" action="{{ 'App\AccountStaff' == Auth::getProvider()->getModel() ? route('staff.logout') : route('staff.logout') }}" method="POST" style="display: none;">
          @csrf
        </form>
      </li>
    </ul>
