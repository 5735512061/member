            ...
            <div class="col-lg-12">
                <div class="card z-index-2 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="header-title">แก้ไขข้อมูลส่วนตัว <i class="fa fa-caret-down" style="color:#777777;"></i></h3>
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6 mt-2">
                            ...
                            <input class="form-control" type="text" value="{{$member->card_id}}" name="card_id">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6 mt-2">
                          ...
                          <div class="col-md-6 mt-2">
                            ...
                            <input class="form-control" type="text" value="{{$member->surname}}" name="surname">
                          </div>
                          <div class="col-md-6 mt-2">
                            <p>
                            ...
                            <input class="form-control" type="text" value="{{$member->bday}}" name="bday">
                          </div>
                          <div class="col-md-6 mt-2">
                            <p>
                            ...
                            <input class="phone_format form-control" type="text" value="{{$member->tel}}" name="tel">
                          </div>
                        </div>
                        <div class="row">
